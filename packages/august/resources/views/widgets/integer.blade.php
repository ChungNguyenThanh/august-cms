...
if (isset($view) && ($view == 'list')) {
	...
	if ($userField['multiple'] == 'Y') {
		...
		@endphp
		<span class="btn btn-success btn-add-input-number" item-field-name="{{ $userField['field_name'] }}">Thêm</span>
		@php
	} else {
		@endphp
...
@push('js')
<script src="/assets-august/js/widgets/august-integer.js"></script>
@endpush
