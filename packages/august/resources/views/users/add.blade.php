...
<div class="d-flex mb-2 justify-content-end">
    <a href="{{ route('august.users.index') }}" class="btn btn-secondary">{{ trans('August::users.back_to_list') }}</a>
</div>
@endif

@push('css')
<link href="/assets-august/css/widgets/august-user.css" rel="stylesheet" type="text/css" />
@endpush
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" role="form" action="{{ route('august.users.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary" name="btn_action" value="save">{{ trans('August::users.btn_save') }}</button>
                        <button type="submit" class="btn btn-success ms-1 me-1" name="btn_action" value="apply">{{ trans('August::users.btn_apply') }}</button>
                        <button type="button" class="btn btn-secondary">{{ trans('August::users.btn_cancel') }}</button>
                    </div>
                </form>
